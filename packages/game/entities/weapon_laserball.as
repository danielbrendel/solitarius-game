...
class CLaserBallEntity : IScriptedEntity
{
	...
	{
		if ((@ref != @this.m_pOwner) && (ref.GetName() != this.GetName()) && (ref.GetName() != this.m_pOwner.GetName()) && (ref.GetName() != "weapon_laser") && (ref.GetName() != "weapon_missile") && (ref.GetName() != "weapon_gun")) {
			this.m_bRemove = true;
